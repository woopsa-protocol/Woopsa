...
namespace Woopsa
{
    public class WoopsaSubscriptionServiceImplementation : IWoopsaSubscriptionService, IDisposable
    {
        #region Constructor
        ...
        public static WoopsaSubscriptionServiceImplementation CurrentService => _currentService.Value;
        ...
        private static AsyncLocal<WoopsaSubscriptionServiceImplementation> _currentService = new AsyncLocal<WoopsaSubscriptionServiceImplementation>();
