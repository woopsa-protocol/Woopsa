...
void WoopsaServerInit(WoopsaServer* server, WoopsaChar8* prefix, WoopsaEntry entries[], WoopsaUInt16(*handleRequest)(WoopsaChar8*, WoopsaUInt8, WoopsaChar8*, WoopsaUInt16)) {
